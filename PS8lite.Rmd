...
1. Why didn't I apply the same change to the `test` set?  
  Our `test` set will not contain the outcome variable, therefore not needing the transformation.
1. If I transformed the outcome variable now, what will I have to make sure to do later on?
It will be necessary to revert the variable back to its original form before making the Kaggle submission later on.
...
![](images/submission_rfcaret.png){ width=100% }
